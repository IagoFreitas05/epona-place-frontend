        ...
        <template v-slot:content>
            ...
            <div class=" w-full ">
              <form class=" flex  rounded grid gap-10 mb-4" @submit.prevent="editUserData()" autocomplete="on">
                <div class="sm:grid md:grid md:grid-cols-2 lg:grid-cols-2  sm:grid-cols-1 md:gap-4">
                  <div class="items-center  bg-white   shadow rounded-md p-5 ">
                    <div class="mb-4">
          ...
          <div class="w-full mx-auto      mb-4">
            <div class="sm:grid sm:grid-cols-1 md:grid md:gap-4 md:grid-cols-3 mb-3">
              ...
              <button @click="showCardModal" class=" shadow-lg bg-white  text-purple-400 font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline" id="new-credit-card">novo cartão de crédito</button>
              <button @click="showFormAddAddres" class=" shadow-lg bg-white   text-purple-400 font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline" id="new-deliver-address">novo endereço de entrega</button>
            </div>

            <div class="sm:grid sm:grid-cols-1  md:grid md:gap-4 md:grid-cols-2" v-if="showCardAndAddress === true">
              <!-- cartões de crédito -->
              <div class="items-center bg-white  items-center shadow-md rounded-md p-5 ">
              ...
              <!-- endereço de entrega -->
              <div class="items-center bg-white   shadow-md rounded-md p-5 ">
